...
/* callback to objective-c */
typedef int (*tCallbackFunction)(void *pUserData);
typedef int (*tCallbackMicStandby)(int sfreq, void *pUserData);
typedef int (*tCallbackMicBegin)(char *arg, void *pUserData);
typedef int (*tCallbackMicRead)(SP16 *buf, int sampnum, void *pUserData);

/* Register callback function */
void RegisterCallbackFunction(int type, tCallbackFunction pFn, void *pUserData);
